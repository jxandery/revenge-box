...
function renderPost(post) {
  $('#latest-posts').append(
      ...
      + "<input class='form-control' type='text' id='post-description'></div></div><div class='row'><div class='col-sm-8'>"
      + "<h6>Edit Body</h6><input class='form-control' type='text' id='post-body'></div></div><input "
